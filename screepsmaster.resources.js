...
function summarize_room_internal(room) {
    ...
    const num_tobeprepaired = Memory.rooms[room.name] && Memory.rooms[room.name].toBeRepaired ? Memory.rooms[room.name].toBeRepaired.length : 0;
    ...
    const toBeRepaired = room.memory.toBeRepaired?room.memory.toBeRepaired.length:0;
